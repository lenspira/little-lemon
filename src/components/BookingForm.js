    ...
    return (
        <form id="booking-form" data-testid='booking-form' onSubmit={handleFormSubmit}>
            ...
            <div className="field">
                ...
                <select id="time" className={timeFieldClass} value={time} onChange={e => setTime(e.target.value)}>
            ...
            <div className="field">
                ...
                <select id="occasion" className="field-valid" required value={occasion} onChange={e => setOccasion(e.target.value)}>
